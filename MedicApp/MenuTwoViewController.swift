...
class MenuTwoViewController: UIViewController {
    ...
    func configureBackImagen(){
        ...
        backImagen.image = UIImage(named: "imagenMenuTwo")
    ...
    func configureDescriptionText(){
        ...
        descriptionText.text = "Realizar  citas medicas  con \n fecha y hora  a tu elección."
